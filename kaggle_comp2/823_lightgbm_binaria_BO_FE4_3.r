...
PARAM$experimento <- "HT8230_FE4_3"
...
PARAM$input$training <- c(201901, 201902, 201903,202001,202002,202003, 202101, 202102, 202103)
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeNumericParam("feature_fraction", lower = 0.05, upper = 0.8),
