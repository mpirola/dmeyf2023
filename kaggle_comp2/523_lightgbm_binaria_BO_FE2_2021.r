...
PARAM$experimento <- "HT5230_FE2_2021"
...
PARAM$input$training <- seq(202101,202105,1)
...
hs <- makeParamSet(
  ...
  makeNumericParam("feature_fraction", lower = 0.3, upper = 0.7),
  makeIntegerParam("min_data_in_leaf", lower = 50L, upper = 8000L),
