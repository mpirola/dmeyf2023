...
#### uso los hp de la OB realizada para v2, en este caso son los hp de la
# iteracion 33 que tiene una ganancia un poco inferior pero menor FF

PARAM$experimento <- "KA8240_FE1_hpbasicos2_v3_kaggle"
...
for (i in 1:20) {
  ...
  PARAM$finalmodel$optim$num_iterations <- 368
  
  PARAM$finalmodel$optim$learning_rate <- 0.0213904536794471
  
  PARAM$finalmodel$optim$feature_fraction <- 0.69483067047768


  PARAM$finalmodel$optim$min_data_in_leaf <-7073
  
  PARAM$finalmodel$optim$num_leaves <- 638
