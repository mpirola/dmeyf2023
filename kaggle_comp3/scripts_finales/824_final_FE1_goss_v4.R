...
PARAM <- list()
PARAM$experimento <- "KA8240_FE1_goss_v4_kaggle"
...
for (i in 1:20) {
  ...
  PARAM$finalmodel$optim$num_iterations <- 191
  
  PARAM$finalmodel$optim$learning_rate <- 0.0550118027955638
  
  PARAM$finalmodel$optim$feature_fraction <- 0.774811490351585

  PARAM$finalmodel$optim$min_data_in_leaf <- 11244
  
  PARAM$finalmodel$optim$num_leaves <- 643
  
  PARAM$finalmodel$optim$feature_fraction_bynode <- 0.597660787840257

  PARAM$finalmodel$optim$max_depth <- 10
    
  PARAM$finalmodel$optim$top_rate <- 0.898655651753166
  
  PARAM$finalmodel$optim$other_rate <- 0.0860522668386003
