...
PARAM <- list()
PARAM$experimento <- "KA8240_FE1_goss_v2_hp2_kaggle"
...
PARAM$input$training <- c(201904,201905,201906,201907,
                          ...
                          202011,202012,
                          202102,202102,202103,202104,202105,202106,202107)
...
for (i in 1:20) {
  ...
  PARAM$finalmodel$optim$num_iterations <- 171
  
  PARAM$finalmodel$optim$learning_rate <- 0.0551704140502125
  
  PARAM$finalmodel$optim$feature_fraction <- 0.779696722931395


  PARAM$finalmodel$optim$min_data_in_leaf <-11552
  
  PARAM$finalmodel$optim$num_leaves <- 715
  
  PARAM$finalmodel$optim$feature_fraction_bynode <- 0.503007117712361


  PARAM$finalmodel$optim$max_depth <- 28
    
  PARAM$finalmodel$optim$top_rate <- 0.85975281886038
  
  PARAM$finalmodel$optim$other_rate <- 0.139138318278904
